...
const MessageCirclePlus: React.FC<IconsProps> = ({ variant = 'linear', ...props }) => {
  switch (variant) {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M11 9C11 8.44771 11.4477 8 12 8C12.5523 8 13 8.44771 13 9V11H15C15.5523 11 16 11.4477 16 12C16 12.5523 15.5523 13 15 13H13V15C13 15.5523 12.5523 16 12 16C11.4477 16 11 15.5523 11 15V13H9C8.44771 13 8 12.5523 8 12C8 11.4477 8.44771 11 9 11H11V9Z" fill="currentColor"/>
</svg>
        )
