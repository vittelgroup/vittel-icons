...
<path d="M3 21H21M18 21V6.2C18 5.0799 18 4.51984 17.782 4.09202C17.5903 3.71569 17.2843 3.40973 16.908 3.21799C16.4802 3 15.9201 3 14.8 3H9.2C8.0799 3 7.51984 3 7.09202 3.21799C6.71569 3.40973 6.40973 3.71569 6.21799 4.09202C6 4.51984 6 5.0799 6 6.2V21M15 12H15.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"/>
    ...
    case 'monochrome':
      return (        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M5 6.8V22H19V6.8C19 5.11984 19 4.27976 18.673 3.63803C18.3854 3.07354 17.9265 2.6146 17.362 2.32698C16.7202 2 15.8802 2 14.2 2H9.8C8.11984 2 7.27976 2 6.63803 2.32698C6.07354 2.6146 5.6146 3.07354 5.32698 3.63803C5 4.27976 5 5.11984 5 6.8Z" fill="currentColor"/>
...
<path d="M3 20C2.44772 20 2 20.4477 2 21C2 21.5523 2.44772 22 3 22H5V20H3Z" fill="currentColor"/>
<path d="M21 20H19V22H21C21.5523 22 22 21.5523 22 21C22 20.4477 21.5523 20 21 20Z" fill="currentColor"/>
</svg>
        )
