...
const EngineWarning: React.FC<IconsProps> = ({ variant = 'linear', ...props }) => {
  switch (variant) {
    
    case 'linear':
      return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M12 16H12.01M12 11V13M14 8V5M11 5H17M6 12H3M3 9V15M21 11V19M6 8V16H8L10 19H18V10L16 8H6Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"/>
</svg>
)
    case 'solid':
      return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path fill-rule="evenodd" clip-rule="evenodd" d="M10 5C10 4.44772 10.4477 4 11 4H17C17.5523 4 18 4.44772 18 5C18 5.55228 17.5523 6 17 6H15V7H16C16.2652 7 16.5196 7.10536 16.7071 7.29289L18.7071 9.29289C18.8946 9.48043 19 9.73478 19 10V19C19 19.5523 18.5523 20 18 20H10C9.66565 20 9.35342 19.8329 9.16795 19.5547L7.46482 17H6C5.44772 17 5 16.5523 5 16V13H4V15C4 15.5523 3.55228 16 3 16C2.44772 16 2 15.5523 2 15V9C2 8.44772 2.44772 8 3 8C3.55228 8 4 8.44772 4 9V11H5V8C5 7.44772 5.44772 7 6 7H13V6H11C10.4477 6 10 5.55228 10 5ZM12 10C12.5523 10 13 10.4477 13 11V13C13 13.5523 12.5523 14 12 14C11.4477 14 11 13.5523 11 13V11C11 10.4477 11.4477 10 12 10ZM13 16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16C11 15.4477 11.4477 15 12 15C12.5523 15 13 15.4477 13 16Z" fill="currentColor"/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M18.7071 9.29289C18.8946 9.48043 19 9.73478 19 10V19C19 19.5523 18.5523 20 18 20H10C9.66565 20 9.35342 19.8329 9.16795 19.5547L7.46482 17H6C5.44772 17 5 16.5523 5 16V8C5 7.44772 5.44772 7 6 7H16C16.2652 7 16.5196 7.10536 16.7071 7.29289L18.7071 9.29289ZM12 10C12.5523 10 13 10.4477 13 11V13C13 13.5523 12.5523 14 12 14C11.4477 14 11 13.5523 11 13V11C11 10.4477 11.4477 10 12 10ZM13 16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16C11 15.4477 11.4477 15 12 15C12.5523 15 13 15.4477 13 16Z" fill="currentColor"/>
</svg>
)
    default:
      return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
