...
const DiscAlt: React.FC<IconsProps> = ({ variant = 'linear', ...props }) => {
  switch (variant) {
...
<path d="M12 5C11.4477 5 11 5.44772 11 6C11 6.55228 11.4477 7 12 7C14.7614 7 17 9.23858 17 12C17 12.5523 17.4477 13 18 13C18.5523 13 19 12.5523 19 12C19 8.13401 15.866 5 12 5Z" fill="currentColor"/>
<path d="M7 12C7 11.4477 6.55228 11 6 11C5.44772 11 5 11.4477 5 12C5 15.866 8.13401 19 12 19C12.5523 19 13 18.5523 13 18C13 17.4477 12.5523 17 12 17C9.23858 17 7 14.7614 7 12Z" fill="currentColor"/>
