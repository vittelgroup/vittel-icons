...
const MessageCircleLinesAlt: React.FC<IconsProps> = ({ variant = 'linear', ...props }) => {
  switch (variant) {
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7 10C7 9.44771 7.44772 9 8 9H16C16.5523 9 17 9.44771 17 10C17 10.5523 16.5523 11 16 11H8C7.44772 11 7 10.5523 7 10ZM7 14C7 13.4477 7.44772 13 8 13H16C16.5523 13 17 13.4477 17 14C17 14.5523 16.5523 15 16 15H8C7.44772 15 7 14.5523 7 14Z" fill="currentColor"/>
</svg>
        )
...
export default MessageCircleLinesAlt;