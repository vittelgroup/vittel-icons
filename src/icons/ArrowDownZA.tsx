...
const ArrowDownZA: React.FC<IconsProps> = ({ variant = 'linear', ...props }) => {
  switch (variant) {
    
    case 'linear':
      return (        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path d="M7 3V21M7 21L3 17M7 21L11 17M15.5 3H20.5L15.5 10H20.5M16 20H20M15 21L18 14L21 21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"/>
</svg>
        )
    
    case 'solid':
      return (        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<path fill-rule="evenodd" clip-rule="evenodd" d="M7 2C7.55228 2 8 2.44772 8 3V18.5858L10.2929 16.2929C10.6834 15.9024 11.3166 15.9024 11.7071 16.2929C12.0976 16.6834 12.0976 17.3166 11.7071 17.7071L7.70711 21.7071C7.31658 22.0976 6.68342 22.0976 6.29289 21.7071L2.29289 17.7071C1.90237 17.3166 1.90237 16.6834 2.29289 16.2929C2.68342 15.9024 3.31658 15.9024 3.70711 16.2929L6 18.5858V3C6 2.44772 6.44772 2 7 2ZM14.5 3C14.5 2.44772 14.9477 2 15.5 2H20.5C20.8746 2 21.2178 2.20935 21.3892 2.54242C21.5606 2.87549 21.5315 3.27642 21.3137 3.58124L17.4432 9H20.5C21.0523 9 21.5 9.44772 21.5 10C21.5 10.5523 21.0523 11 20.5 11H15.5C15.1254 11 14.7822 10.7907 14.6108 10.4576C14.4394 10.1245 14.4685 9.72358 14.6863 9.41876L18.5568 4H15.5C14.9477 4 14.5 3.55228 14.5 3ZM18 13C18.4 13 18.7616 13.2384 18.9191 13.6061L21.9191 20.6061C22.1367 21.1137 21.9015 21.7016 21.3939 21.9191C20.8863 22.1367 20.2984 21.9015 20.0809 21.3939L19.912 21H16.088L15.9191 21.3939C15.7016 21.9015 15.1137 22.1367 14.6061 21.9191C14.0985 21.7016 13.8633 21.1137 14.0809 20.6061L17.0809 13.6061C17.2384 13.2384 17.6 13 18 13ZM16.9451 19H19.0549L18 16.5386L16.9451 19Z" fill="currentColor"/>
</svg>
        )
...
<path d="M7 3V21M7 21L3 17M7 21L11 17M15.5 3H20.5L15.5 10H20.5M15.4286 20H20.5714M15 21L18 14L21 21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"/>
</svg>
        )
    ...
    case 'monochrome':
      return (        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
<g opacity="0.3">
<path d="M15.5003 2C14.948 2 14.5003 2.44772 14.5003 3C14.5003 3.55228 14.948 4 15.5003 4H18.5571L14.6865 9.41876C14.4688 9.72358 14.4397 10.1245 14.6111 10.4576C14.7825 10.7907 15.1257 11 15.5003 11H20.5003C21.0525 11 21.5003 10.5523 21.5003 10C21.5003 9.44772 21.0525 9 20.5003 9H17.4434L21.314 3.58124C21.5317 3.27642 21.5608 2.87549 21.3894 2.54242C21.218 2.20935 20.8748 2 20.5003 2H15.5003Z" fill="currentColor"/>
